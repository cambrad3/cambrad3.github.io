...
#### Supervised
We used supervised learning to predict the career winshares of a player by using their rookie data. We went through different analysis approaches to pick the most important features in the rookie matrix. Furthermore these features were used by various models. Further analysis was done by comparing the RMSE, R-squared and Mean Absolute Error values generated by these models.  
